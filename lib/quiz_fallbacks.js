...
export function fallbackPremiumCopy(quiz = {}, archetypeLabel = "Primary Archetype", archetypePreview = "") {
  ...
  return {
    ...
    opening: preview,
    body:
      `You are not just ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œdoing this for no reason.ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â There is a shape to how your mind handles ${quizTitle.toLowerCase()}, and once that shape becomes visible, it stops feeling so random. ` +
