...
export function fallbackPremiumCopy(quiz = {}, archetypeLabel = "Primary Archetype", archetypePreview = "") {
  ...
  return {
    ...
    opening: preview,
    body:
      `You are not just â€œdoing this for no reason.â€ There is a shape to how your mind handles ${quizTitle.toLowerCase()}, and once that shape becomes visible, it stops feeling so random. ` +
