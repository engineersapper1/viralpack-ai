...
export default function Page() {
  ...
  async function submitWaitlist(e) {
    ...
    try {
      ...
      setStatus({
        type: "ok",
        msg: "You’re on the list. We’ll email you when beta opens.",
      });
    } catch (err) {
      setStatus({
        type: "err",
        msg: "Couldn’t submit right now. Try again in a minute.",
      });
    }
  }
  ...
  return (
    <div className="vp-bg">
      ...
      <div className="container vp-foreground">
        <div className="nav">
          <div className="brand">
            <img
              src="/logo.png"
        ...
        <main className="hero">
          <div className="heroGrid">
            <div className="card">
              ...
              <p className="sub">
                Enter 5 details. Get an agency-ready pack: hooks, scripts, shot
                lists, overlays, captions, and top hashtags. Built to be fast,
                specific, and shootable.
              </p>
              ...
              <p className="smallNote">
                No install. Runs online. Pay-to-play coming after beta.
              </p>
            </div>
            ...
            <div className="card">
              ...
              >
                <div>
                  ...
                  <p className="stepBody">
                    Brand, product, offer, website, market. Nothing else.
                  </p>
                </div>
                <div>
                  <p className="stepTitle">2) Generate the pack</p>
                  <p className="stepBody">
                    Trend-aware structure, creative execution, no fluff.
                  </p>
                </div>
                <div>
                  <p className="stepTitle">3) Download and shoot</p>
                  <p className="stepBody">
                    Hand the pack to your editor or film it yourself.
                  </p>
                </div>
              </div>
              ...
              <p className="stepBody" style={{ marginTop: 8 }}>
                Credits + subscriptions are coming. Beta users get founder
                pricing.
              </p>
            </div>
          </div>
        ...
        <section className="section" id="example">
          <div className="card">
            ...
            <p className="stepBody">
              This is a trimmed preview. Your real output includes the full
              script, shot list, overlays, captions, and hashtags.
            </p>
        ...
        <section className="section" id="waitlist">
          <div className="card">
            ...
            <form onSubmit={submitWaitlist} style={{ marginTop: 12 }}>
              ...
              {status.type === "ok" && (
                <div className="toastOk">{status.msg}</div>
              )}
              {status.type === "err" && (
                <div className="toastErr">{status.msg}</div>
              )}
            </form>
          </div>
        </section>
